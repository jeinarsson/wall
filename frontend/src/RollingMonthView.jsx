...
// visibleDays enumerates days from start of current week and 5 weeks ahead.
function visibleDays(date, localizer) {
  let current = dates.startOf(date, 'week', localizer.startOfWeek());
  let last = dates.add(current, 7*5-1, 'day');
  let days = [];
